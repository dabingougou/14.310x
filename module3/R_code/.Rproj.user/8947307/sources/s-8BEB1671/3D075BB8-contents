...
bihar_young_adult_femailes <- filter(bihar_data, adult==1, age<=40)
bihar_old_adult_femailes <- filter(bihar_data, adult==1, age>40)
bihar_adult_males <-filter(bihar_data, adult==1,male=1) 

ggplot(bihar_young_adult_femailes, aes(x = weight_kg, ..density..)) + 
  geom_histogram(binwidth = 2, 
                 fill = "red") + 
  geom_density(kernel = "gaussian", aes(x = weight_kg))
ggplot(bihar_old_adult_femailes, aes(x = weight_kg)) + geom_histogram(binwidth = 2)
